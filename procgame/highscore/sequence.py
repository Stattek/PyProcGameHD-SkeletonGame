...
class EntrySequenceManager(Mode):
    ...
    def prompt(self):
        ...
        self.prompt_for_initials(
            left_text=self.active_prompt.left, right_text=self.active_prompt.right
        )
    ...
    def prompt_for_initials(self, left_text, right_text):
        self.highscore_entry = self.create_highscore_entry_mode(
            left_text, right_text, self.highscore_entered
        )
