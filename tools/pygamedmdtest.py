        ...
        while 1:
            ...
            if pygame.font:
                ...
                textpos = text.get_rect(
                    center=(x, background.get_height() / 2)
                ...
                textpos = text.get_rect(
                    center=(
                        math.cos(time.clock() * 5.0) * 10.0
                        + background.get_width() / 2,
                        math.sin(time.clock() * 5.0) * 5.0
                        + background.get_height() * 0.3,
                    )
                )
                background.blit(text, textpos)
                ...
                textpos = text.get_rect(
                    center=(
                        background.get_width() * 0.5,
                        background.get_height() * 0.75,
                    )
                )
                background.blit(text, textpos)
